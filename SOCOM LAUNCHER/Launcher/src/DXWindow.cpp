...
namespace SOCOMLauncher {
    ...
    void DXWindow::SV_RAINBOW(float saturation, float value, float opacity)
    {
    ...
    void DXWindow::Initialize()
    {
        ...
        ::RegisterClassEx(&wc);
        //hwnd = ::CreateWindow(wc.lpszClassName, _T("NightFyre Launcher"), WS_BORDER, 100, 100, 270, 350, NULL, NULL, wc.hInstance, NULL);
        hwnd = ::CreateWindow(wc.lpszClassName, _T("NightFyre Launcher"), WS_OVERLAPPEDWINDOW, 0, 0, 0, 0, NULL, NULL, wc.hInstance, NULL);
