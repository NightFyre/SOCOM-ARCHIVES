...
bool ManualMap(HANDLE hProc, int GAME)
{
	...
	case(0): {
		//  SOCOM1
		LoadFileInResource(IDR_SOCOM, inSOCOM, Size, rdata);
		break;
	}
	case(1): {
		//  SOCOM2
		LoadFileInResource(IDR_SOCOM2, inSOCOM2, Size, rdata);
		break;
	}
	case(2): {
		//  SOCOM 3
		LoadFileInResource(IDR_SOCOM3, inSOCOM3, Size, rdata);
		break;
	}
	case(3): {
		//  SOCOM CA
		LoadFileInResource(IDR_SOCOMCA, inSOCOMCA, Size, rdata);
		break;
	}
	case(4): {
		return FALSE;
