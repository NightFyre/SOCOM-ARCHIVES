...
//  3 = SOCOMCA
//  4 = NO GAME
static void ImGui_ImplWin32_UpdateGamepads(int SelectedGame)
{
            ...
            if (COUNT1 >= 25) {
                ...
                case(1):
                    if (SOCOM2::g_GameVariables->m_ShowHud)
                        SOCOM2::g_GameVariables->m_ShowHud = FALSE;
                ...
                case(3):
                    if (SOCOM_CA::g_GameVariables->m_ShowHud)
                        SOCOM_CA::g_GameVariables->m_ShowHud = FALSE;
                    SOCOM_CA::g_GameVariables->m_ShowMenu ^= 1;
                    break;
                case(4):
                    break;
                }
...
void    ImGui_ImplWin32_NewFrame(int SelectedGame)
{
    ImGuiIO& io = ImGui::GetIO();
    ...
    ImGui_ImplWin32_UpdateGamepads(SelectedGame);
}
